  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-0 left-0 w-full h-160 flex flex-col items-center justify-center bg-black/50 rounded-2xl md:h-142">
        <span className="text-7xl text-white font-bold mb-2 lg:text-5xl md:text-2xl md:font-extrabold">
          Empowering Businesses
        </span>
        <span className="text-7xl text-white font-bold lg:text-5xl md:text-2xl md:font-extrabold">through Innovation</span>
        <span className="text-2xl text-white font-light mt-12 lg:text-xl md:text-sm">
