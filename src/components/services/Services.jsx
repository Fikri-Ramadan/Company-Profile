...
export default function Services() {
  return (
    <div className="flex items-center relative">
      <div className="w-128 h-96 bg-cyan-200/25 absolute -z-10 right-24 top-16 origin-center rotate-45"></div>
      <div className="flex-1 flex flex-col">
        <span className="text-base font-semibold tracking-wide mb-8">
          OUR SERVICES
        </span>
        ...
        <Link
          href="/services"
          className="font-light bg-cyan-400 w-max rounded-lg px-4 py-2 hover:bg-cyan-500"
        >
          Explore More
        </Link>
      </div>
      <div className="flex-auto max-w-2xl grid grid-rows-4 grid-flow-col gap-4">
        <div className="row-start-2 row-span-2 w-48 h-64 bg-slate-50 p-6 shadow-lg">
          <div className="w-12 h-12 bg-cyan-300 rounded-full">
        ...
        <div className="row-end-3 row-span-2 w-48 h-64 bg-slate-50 p-6 shadow-lg">
          <div className="w-12 h-12 bg-cyan-300 rounded-full">
        ...
        <div className="row-start-3 row-end-5 w-48 h-64 bg-slate-50 p-6 shadow-lg">
          <div className="w-12 h-12 bg-cyan-300 rounded-full">
        ...
        <div className="row-start-2 row-end-4  w-48 h-64 bg-slate-50 p-6 shadow-lg">
          <div className="w-12 h-12 bg-cyan-300 rounded-full">
