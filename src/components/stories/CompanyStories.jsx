...
export default function CompanyStories() {
  return (
    <div className="relative">
      ...
      />
      <div className="absolute top-0 left-0 w-full h-160 pl-32 flex flex-col gap-8 items-start justify-center bg-black/60 rounded-2xl mobile:h-142">
        <span className="text-lg text-white font-medium">Our Story</span>
        <span className="w-1/2 text-4xl text-white font-extrabold">
          Emerged as a beacon of innovation and excellence
        </span>
        <span className="w-1/2 text-white font-light">
