...
export default function EmployeeCard({
  ...
  return (
    <div className="relative w-72 bg-cyan-400/80 flex-1 h-80 flex flex-col justify-center items-center rounded-xl shadow-md tablet:bg-cyan-800/90 mobile:py-8">
      <div className="relative">
        ...
        />
        <div className="absolute w-full h-full bg-black/10 top-0 rounded-full"></div>
      </div>
      <div className="text-center mt-8 space-y-2 text-black tablet:text-white">
