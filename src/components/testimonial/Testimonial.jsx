  ...
  return (
    <div className="py-24 max-w-7xl mx-auto">
      <div className="text-center text-white mb-16">
        <span className="text-4xl font-bold mobile:text-3xl">
          Best Reasons To Choose Our Services
        </span>
      </div>
      <div className="text-white flex justify-center mobile:flex-col mobile:gap-16">
        ...
        <div className="flex-1 flex flex-col items-center gap-y-6 border-x-4 border-slate-600 mobile:border-none">
      ...
      <div className="flex justify-center items-center gap-8 text-white mt-16 mobile:flex-col ">
        <div className="w-1/3 tablet:w-2/5 mobile:w-11/12">
          <TestimonialCard
